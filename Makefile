...
# Copyright (C) 2015-2016 MOLMC-IntoRobot
#
...
define KernelPackage/rt2860v2
  ...
  FILES:=$(PKG_BUILD_DIR)/rt2860v2_ap/rt2860v2_ap.ko $(PKG_BUILD_DIR)/rt2860v2_sta/rt2860v2_sta.ko
  AUTOLOAD:=$(call AutoLoad,50, RALINK_MODULES)
endef
...
MAKEOPTS:= -C $(LINUX_DIR) \
              ...
              M="$(PKG_BUILD_DIR)/rt2860v2_ap $(PKG_BUILD_DIR)/rt2860v2_sta" \
...
define KernelPackage/rt2860v2/install
	...
	$(INSTALL_DATA) ./files/ralink.sh $(1)/lib/wifi
endef
